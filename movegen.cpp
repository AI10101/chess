...
int moveGen(Board& board, move* moves) {
    ...
    addMovesFromAttackMask(moves, cnt, attacks & board.empty, kingSq);
    addMovesFromAttackMask(moves, cnt, attacks & board.colour[us], kingSq, 0b0100);
    ...
    while (moveMask) {
        ...
        addMovesFromAttackMask(moves, cnt, attacks & board.empty, knightSq);
        addMovesFromAttackMask(moves, cnt, attacks & board.colour[us], knightSq, 0b0100);
    }
    ...
    while (moveMask) {
        ...
        addMovesFromAttackMask(moves, cnt, mask & board.empty, sq);
        addMovesFromAttackMask(moves, cnt, mask & board.colour[us], sq, 0b0100);
    }
